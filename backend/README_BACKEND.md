...
```
यह password जैसी चीज़ है। खाली छोड़ोगे तो जिसके पास URL होगा वह Sheet में लिख सकेगा —
इसलिए कुछ न कुछ ज़रूर डालो। यही अक्षर बाद में app की ⚙ सेटिंग में भी डालने होंगे (हूबहू वही)।
