...
Project URL और anon key **app में पहले से भरे आते हैं** (`config.js` — v1.24.0
से)। ⚙ सेटिंग → **☁️ Cloud backup (Supabase)** में बस:
...
→ **☁️ जोड़ो और मिलाओ**। ऊपर ✅ आ जाए तो हो गया। (किसी और project से जोड़ना
हो तो `config.js` का `supa` block ख़ाली करने पर चारों खाने फिर दिखते हैं।)

> Password app/repo में कभी नहीं भरा जाता — repo public है, password ही असली
> चाबी है। वह सिर्फ़ फ़ोन पर एक बार डलता है; app उसे save भी नहीं करती, सिर्फ़
> मिले हुए token रखती है।
